...
class BatchEpisode(object):
    def __init__(self, args, gamma = 0.95):
        self.args = args
        self.batch_size = self.args.batch_size_run
        self.gamma = gamma
        self.device = self.args.device

        self._observations_list = [[] for _ in range(self.batch_size)]
        self._actions_list = [[] for _ in range(self.batch_size)]
        self._rewards_list = [[] for _ in range(self.batch_size)]
        self._mask_list = []
