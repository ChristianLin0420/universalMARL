...
class Fouseformer(nn.Module):
    ...
    def forward(self, a, e, h, q, mask):
        ...
        enemy_action_token = self.enemy_action_token_embedding(e)
        q = torch.repeat_interleave(q, enemy_action_token.size(0), 0)
    ...
    def fixed_models_weight(self):
        ...
        self.enemy_action_token_embedding.requires_grad = False
