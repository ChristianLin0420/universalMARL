...
class AxialTransformerAgent(nn.Module):
    def __init__(self, input_shape, args):
        super(AxialTransformerAgent, self).__init__()
        self.args = args
        self.transformer = Transformer(args.token_dim, args.depth, args.heads)
    ...
    def forward(self, inputs, hidden_state, task_enemy_num, task_ally_num, env = "sc2"):
...
if __name__ == '__main__':
    ...
    # testing the agent
    agent = AxialTransformerAgent(None, args).cuda()
