...
import torch
from modules.helpers.models.stformer import STformer
from modules.helpers.embedding.dummy_generator import DummyGenerator


class STformerAgent(nn.Module):
    def __init__(self, input_shape, args):
        super(STformerAgent, self).__init__()
        self.args = args

        self.dummy_generator = DummyGenerator(args.device)
        
        self.transformer = STformer(args, args.token_dim, args.emb)
